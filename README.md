...
- 沖縄文芸フリマ案内所、画像公開、今後のAI接続に関する安全ルールは `SAFETY_AND_PUBLICATION.md` を正本とします。

## 沖縄文芸フリマ案内所 Phase 1〜2

`ai-editor/` は、8つの立場別入口と総合案内、さまざまな参加のしかた、作品棚、昨年の会場写真、今年試したい「ありがとう」の記録、田場の記憶を集める構想のUIを提供します。
